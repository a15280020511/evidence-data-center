#!/usr/bin/env python3
"""Reject duplicate managed YuanDian legal API task IDs or equivalent ticket bodies across Issues."""
...
def _api_json(url: str, token: str) -> Any:
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "managed-yuandian-api-center",
        },
    )
    ...
    *,
    ...
    for page in range(1, 6):
        ...
        for row in rows:
            ...
            if not title.startswith(("[api-yuandian]",)):
                continue
            try:
